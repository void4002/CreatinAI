                ...
                <div className="card bg-secondary text-secondary-content">
                  <div className="card-body gap-4">
                    <div className='flex items-center'>
                      <div className="avatar flex-shrink-0">
                        <div className="w-16 rounded-full border-2 border-white">
                          <img src="https://placeimg.com/99/99/people" alt=''/>
                        </div>
                      </div>
                ...
                <div className="card bg-secondary text-secondary-content">
                  <div className="card-body gap-4">
                    <div className='flex items-center'>
                      <div className="avatar flex-shrink-0">
                        <div className="w-16 rounded-full border-2 border-white">
                          <img src="https://placeimg.com/98/98/people" alt='' />
                        </div>
                      </div>
                ...
                <div className="card bg-secondary text-secondary-content">
                  <div className="card-body gap-4">
                    <div className='flex items-center'>
                      <div className="avatar flex-shrink-0">
                        <div className="w-16 rounded-full border-2 border-white">
                          <img src="https://placeimg.com/97/97/people" alt=''/>
                        </div>
                      </div>
                ...
                <div className="card bg-secondary text-secondary-content">
                  <div className="card-body gap-4">
                    <div className='flex items-center'>
                      <div className="avatar flex-shrink-0">
                        <div className="w-16 rounded-full border-2 border-white">
                          <img src="https://placeimg.com/96/96/people" alt=''/>
                        </div>
                      </div>
                ...
                <div className="card bg-secondary text-secondary-content">
                  <div className="card-body gap-4">
                    <div className='flex items-center'>
                      <div className="avatar flex-shrink-0">
                        <div className="w-16 rounded-full border-2 border-white">
                          <img src="https://placeimg.com/95/95/people" alt=''/>
                        </div>
                      </div>
